...
- No future feature suggestions at this time.


# Design

- The design of the website was inspired by researching other websites to find out what designs created a positive user experience.

- Consideration was also researched for how the design would be impacted by viewing the content on multiple browsers and browser types.

- Designs were created using a digital interface such as Balsamiq and that provided the design a loayout view for both mobile and tablet view as shown below.
...
- A Favicon was generated to give the website an identifier for the company initials and displayed at the top of the browser tab. The size of the image created, is a 16x16 icon and is referenced in the head section of the html page.

![Favicon: P&D](assets/images/favicon_pd.png)


## Header

- The header consists of a company logo with the emphasis on the owner's name, as it is shown as larger and a brighter colour compared to the rest of the logo.
...
- Once the screen size is increased to 768px or higher, the hamburger menu disappears and it displays the navigation bar menu instead. See for following image:
...
- The showcase image was added below the header section. It provides a view of some of the tools and preparation that maybe required before a job takes place. 

- Image shows a wooden ladder on the right with a long-handled paint roller beside it. There is a tin of paint, a paint roller tray, paint brush to the left of the image. 

- There is covering placed on the floor and blue tape placed over the skirting board.

- There is overlay text that provides a heading a paragraph text to the user.

- A 'Get in Touch' button is added which has a call to action and it links to the About Page that allows the user to complete the Contact form.

![Showcase Section](assets/images/showcase-image-min.webp)
...
- Contains a signup option for user to enter a valid email address to submit and join the mailing list.
    - Email Address
    - Subscribe Button to submit form

![Newsletter Section](assets/images/newsletter_section.webp)


- The 'Subscribe' button prevents the user from submitting the form unless there is a valid email address provided (required). 
- The user will be prompted to add a valid email and if successful, the user will be provided with a newsletter signup thank you page.

![Newsletter Signup Validation](assets/images/newsletter_validation.png)
...
![About Us](assets/images/about-us-min.webp)
...
- Contact Us Form requires user input, such as:
    - First Name
    - Last Name
    - Email Address
    - Contact Us
        ...
        - General Enquiry
    - Message Box
        - User fills in the request for information
    - Send Button to submit form
    - Reset Button to reset form

![Contact Form](assets/images/contact_form.webp)

- Contact Form has form validation which prevents user from submitting the form without required data completed.

![Contact Form - Required](assets/images/contact_form_required.webp)
...
- The Footer contains 2 items:

    1. links to Social Network providers.
        ...
        - On hover over each icon, the following happens:
            - Icon increases in size
            - Icon colour changes to white

        - On click over each icon, the following happens:
            - A new browser window opens and loads the social networking website

    2. Developer Author, Copyright and year
...
## - Languages
- HTML5
<img src="assets/images/html5-min.png" alt="html5" width="100px"/> 

- CSS3
<img src="assets/images/css3-min.png" alt="css3" width="72px"/>
...
- [Nu Html Checker](https://validator.w3.org/nu/#textarea):
    - The website was used to validate all HTML code for any errors. Checked all pages and no errors found. Results shown as per image.
...
- [CSS Validator](https://jigsaw.w3.org/css-validator/validator):
    - The website was used to validate the CSS Style code for any errors. No errors found. Results shown as per image.

<img src="assets/images/testing/validate_css_passed.png"/>
...
Steps:
- Input (User): Clicks on live site link or enters in the domain address into address bar
    
[P&D](https://gregcotech007.github.io/paintanddecorate/index.html)
(https://gregcotech007.github.io/paintanddecorate/index.html)

- Output (Browser)
    - Web browser opens to landing page
...
### Newsletter Signup
Steps:
- Input (User): Enters valid email into input box in newsletter section

- Output (Browser)
    - User is brought to a thank you page
    - User is informed with a congrats and that their email is added to the email list

<img src="assets/images/testing/newsletter-thanks_page.png"/>


### About Us
Steps:
- Input (User): Clicks on About Us in the navigation

- Output (Browser)
    - User is brought to the about page
    - About is highlighted in orange as the selected page being viewed

<img src="assets/images/testing/about-us_page.png"/>


### Contact Us Form
Steps:
- Input (User): Enters valid name, email, enquiry type and message into input boxes and selection in the contact us section

- Output (Browser)
    - User is brought to a thank you page
    - User is informed that a member of staff will get back to them shortly and would be delighted to assist

<img src="assets/images/testing/thank-you_page.png"/>

### Gallery
Steps:
- Input (User): Clicks on Gallery in the navigation

- Output (Browser)
    - User is brought to the Gallery page
    - Gallery is highlighted in orange as the selected page being viewed
    - Images are shown in single view on mobile, 2 images wide on tablet and 3 images wide on desktop and larger

<img src="assets/images/testing/gallery_page.png"/>


### Services
Steps:
- Input (User): Clicks on Services in the navigation

- Output (Browser)
    - User is brought to the Services page
    - Services is highlighted in orange as the selected page being viewed

<img src="assets/images/testing/services_page.png"/>


## Supported Screens and Browsers
- Website compatability was checked with the following devices:
    - iPhone 12 Pro Max
        - Safari
        - Chrome
    - MacBook Pro
...
## Bug Testing
- During the testing phase, I found that there was an issue between the view results on the Dev Tools and Google Chrome, that caused the Testimonials to move out of position and display over the Newsletter Signup. This was not the case when viewed on the Google Chrome directly. This was as a result of the testimonials width set to 30.73%.

### Bug Fixed
- Testimonial Section
    - Changed CSS code for testimonial width to 30%. 
    - Font-size was reduced from 2vw to 1.8vw. 
    - Testimonial span font-size was reduced from 3vw to 2.8vw.

- Head Section
    - Title - Error with title showing up twice in the head. 
    - Removed 2nd title, added additional line comments for explantion. 
    - Added additional line spaces for better viewing of code.
...
- Footer Section 
    - Removed div from below the class social in the footer section, that was causing an error.
...
![Lighthouse Mobile](assets/images/lighthouse-desktop-min.webp)


# Deployment
## GitPod
Starting out writing code, an code editor is required and in this case, I used GitPod.

- Created new respository using Code Institute Gitpod template
- Enter name of new respository
- Click on "Create repository from template"
- Once created, click on GitHub to open
...
- Link style.css file to index.html file
...
- Commit message with description to inform of the changes
